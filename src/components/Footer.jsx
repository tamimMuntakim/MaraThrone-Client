        ...
        <footer className="footer sm:footer-horizontal w-11/12 md:container mx-auto">
            ...
            <nav>
                ...
                <div className="grid grid-flow-col gap-4 md:gap-8">
                    <a href="https://www.facebook.com/tamim.muntakim.02" target='_blank'><FaFacebookSquare className='w-4 h-4 md:w-5 md:h-5' /></a>
                    <a href="https://www.linkedin.com/in/tamim-muntakim-51052625a/" target='_blank'><FaLinkedin className='w-4 h-4 md:w-5 md:h-5' /></a>
                    <a href="https://github.com/tamimMuntakim" target='_blank'><FaGithub className='w-4 h-4 md:w-5 md:h-5' /></a>
                </div>
            </nav>
        </footer>
    );
