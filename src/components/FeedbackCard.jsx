...
const FeedbackCard = ({ feedback }) => {
    ...
    return (
        <>
            <div className="flex flex-col gap-2 md:gap-4 mb-3 bg-base-200 py-2 md:py-4 px-4 md:px-6 rounded-lg shadow-sm hover:shadow-md hover:border-slate-300 border border-slate-200">
